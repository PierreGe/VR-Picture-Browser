...
\title{Intelligent Picture Browser \\ - \\Given One \\  - \\NGUI report}
...
\begin{enumerate}
\item \textbf{Movement} Being in a Virtual Reality, the user can move around, if the space around him allows, and get physically closer to the pictures to analyze them better.\cite{Calado2013}.
...
In the next page you can find an UML diagram of our architecture.
On the top part you can see the Unity scripts, on the bottom part the Manager.
\includepdf[scale=0.8]{umlDiagram.pdf}
